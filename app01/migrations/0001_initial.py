# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-27 05:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(max_length=64, verbose_name='岗位')),
                ('salary', models.IntegerField(verbose_name='薪资')),
                ('welfare', models.CharField(max_length=256, verbose_name='福利')),
                ('date', models.DateField(help_text='格式yyyy-mm-dd', verbose_name='入职时间')),
                ('memo', models.CharField(max_length=256, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('by_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.ClassList', verbose_name='问卷调查班级')),
            ],
        ),
        migrations.CreateModel(
            name='SurveryChoices',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Student', verbose_name='学员姓名')),
                ('survery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Survery', verbose_name='问卷')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=16, null=True, verbose_name='员工姓名')),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rbac.UserInfo', verbose_name='账户')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='booking',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.MeetingRome', verbose_name='会议室'),
        ),
        migrations.AddField(
            model_name='booking',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.UserInfo', verbose_name='预订者'),
        ),
    ]
